...
pub fn main_2_4_3() {
    ...
    let (lightingShader, lampShader, VBO, cubeVAO, lightVAO, diffuseMap, specularMap, emissionMap) = unsafe {
        ...
        let lightingShader = Shader::new(
            "src/_2_lighting/shaders/4.3.lighting_maps.vs",
            "src/_2_lighting/shaders/4.3.lighting_maps.fs");
        let lampShader = Shader::new(
            "src/_2_lighting/shaders/4.3.lamp.vs",
            "src/_2_lighting/shaders/4.3.lamp.fs");
        ...
        lightingShader.setInt(c_str!("material.emission"), 2);


        (lightingShader, lampShader, VBO, cubeVAO, lightVAO, diffuseMap, specularMap, emissionMap)
    };
