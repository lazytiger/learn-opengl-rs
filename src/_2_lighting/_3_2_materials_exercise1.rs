...
pub fn main_2_3_2() {
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            // light properties
            lightingShader.setVector3(c_str!("light.ambient"), &vec3(1.0, 1.0, 1.0));
            lightingShader.setVector3(c_str!("light.diffuse"), &vec3(1.0, 1.0, 1.0));
            lightingShader.setVec3(c_str!("light.specular"), 1.0, 1.0, 1.0);

            // material properties
            lightingShader.setVec3(c_str!("material.ambient"), 0.0, 0.1, 0.6);
            lightingShader.setVec3(c_str!("material.diffuse"), 0.0, 0.50980392, 0.50980392);
            lightingShader.setVec3(c_str!("material.specular"), 0.50196078, 0.50196078, 0.50196078); // specular lighting doesn't have full effect on this object's material
