...
pub fn main_4_5_2() {
    ...
    let (shader, screenShader, cubeVBO, cubeVAO, planeVBO, planeVAO, quadVBO, quadVAO, cubeTexture, floorTexture, framebuffer, textureColorbuffer) = unsafe {
        ...
        let shader = Shader::new(
            "src/_4_advanced_opengl/shaders/5.2.framebuffers.vs",
            "src/_4_advanced_opengl/shaders/5.2.framebuffers.fs");
        let screenShader = Shader::new(
            "src/_4_advanced_opengl/shaders/5.2.framebuffers_screen.vs",
            "src/_4_advanced_opengl/shaders/5.2.framebuffers_screen.fs");
