...
use cgmath::{Matrix4, vec3, Vector3, vec2, Vector2, Deg, perspective, Point3, Rad};
use cgmath::prelude::*;
...
pub fn main_5_5_2() {
    ...
    let (shader, diffuseMap, normalMap, heightMap) = unsafe {
        ...
        let shader = Shader::new(
            "src/_5_advanced_lighting/shaders/5.2.parallax_mapping.vs",
            "src/_5_advanced_lighting/shaders/5.2.parallax_mapping.fs");

        // load textures
        // -------------
        let diffuseMap = loadTexture("resources/textures/bricks2.jpg");
        let normalMap = loadTexture("resources/textures/bricks2_normal.jpg");
        let heightMap = loadTexture("resources/textures/bricks2_disp.jpg");
        ...
        shader.setInt(c_str!("heightMap"), 2);

        (shader, diffuseMap, normalMap, heightMap)
    };
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            shader.setFloat(c_str!("heightScale"), heightScale);
