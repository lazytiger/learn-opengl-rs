...
pub fn main_1_4_5() {
    ...
    let (ourShader, VBO, VAO, EBO, texture1, texture2) = unsafe {
        ...
        let ourShader = Shader::new(
            ...
            "src/_1_getting_started/shaders/4.5.texture.fs");
    ...
    while !window.should_close() {
        // events
        // -----
        process_events(&mut window, &events, &mut mixValue);
        ...
        unsafe {
            ...
            ourShader.setFloat(c_str!("mixValue"), mixValue);
            gl::BindVertexArray(VAO);
